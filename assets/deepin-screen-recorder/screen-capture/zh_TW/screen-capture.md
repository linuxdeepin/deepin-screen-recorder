...
> ![notes](../common/notes.svg)說明：如果熒幕錄影已經預設固定在Dock上，您也可以單擊Dock上的 ![deepin_screenshot](../common/deepin_screenshot.svg)來執行。
...
> ![notes](../common/notes.svg)說明：當電腦多屏顯示時，您也可以使用截圖錄屏來截取不同螢幕上的區域。
...
- 將滑鼠指標置於截圖錄屏區域的白色邊框上，滑鼠指標變為 ![雙箭頭](../common/Mouse_Arrow.svg)

  ，按住滑鼠左鍵不放，拖動滑鼠來放大或縮小截圖區域。

- 按下鍵盤上的 ![ctrl](../common/Ctrl.svg)+![向上](../common/Up.svg) 或 ![向下](../common/Down.svg) 來上下擴展截圖區域，按下鍵盤上的 ![ctrl](../common/Ctrl.svg)+![向左](../common/Left.svg) 或 ![向右](../common/Right.svg) 來左右擴展截圖區域。

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

#### 移動區域位置

將滑鼠指標置於截圖錄屏區域上，滑鼠指標變為 ![手指](../common/hand.svg)。您可以：
...
> ![notes](../common/notes.svg)說明：如果您已經對工具列和屬性欄中如線條粗細、字體大小等進行了選擇，截圖錄屏會儲存設定，再次啟動截圖錄屏，將預設使用該設定，您也可以重新進行選擇。
...
3. 將滑鼠指標置於截圖區域上，滑鼠指標變為 ![矩形指標](../common/rect_mouse.svg)。
...
3. 將滑鼠指標置於截圖區域上，滑鼠指標變為 ![橢圓指標](../common/ellipse_mouse.svg)。
4. 按住滑鼠左鍵不放，拖動滑鼠以完成圖形區域的繪製。
5. 如果截圖中包含了個人隱私訊息，請單擊工具列展開面板中的 ![模糊](../common/vague_normal.svg) 或 ![馬賽克](../common/Mosaic_normal.svg)來塗抹。
...
1. 在截圖區域下方的工具列中，單擊 ![直線](../common/line_normal.svg)。
2. 在工具列展開的面板中，選擇線條的粗細和顏色，有四種顏色可供選擇。
3. 單擊 ![直線](../common/line_normal.svg)或 ![箭頭](../common/Arrow_normal.svg)，在直線和箭頭之間切換。
4. 將滑鼠指標置於截圖區域上，滑鼠指標變為 ![線條指標](../common/line_mouse.svg)或 ![箭頭指標](../common/arrow_mouse.svg)。
...
1. 在截圖區域下方的工具列中，單擊 ![畫筆](../common/Combined_Shape.svg)。
2. 在工具列展開的面板中，選擇畫筆的粗細和顏色，有四種顏色可供選擇。
3. 將滑鼠指標置於截圖區域上，滑鼠指標變為 ![畫筆指標](../common/brush_red.svg)。
...
#### 移動圖形
1. 將滑鼠指標置於圖形的邊線上，此時滑鼠指標變為 ![手指](fig/fingers.png)。
...
2. 單擊滑鼠左鍵，進入圖形編輯模式，您可以：
   ...
   - 將滑鼠指標置於編輯框上，此時滑鼠指標變成 ![雙箭頭](../common/Mouse_Arrow.svg)，透過拖動滑鼠指標，來放大或縮小圖形區域。
   ...
   - 將滑鼠指標置於編輯框的 ![旋轉](../common/icon_rotate.svg) 上，此時滑鼠指標變成 ![旋轉](../common/rotate_mouse.svg)，透過拖動滑鼠指標，來旋轉圖形。
...
1. 在截圖區域下方的工具列中，單擊 ![文字](../common/text_normal.svg)。
2. 在工具列展開面板中，選擇字號和顏色，有四種顏色可供選擇。
3. 將滑鼠指標置於截取的圖片上，此時滑鼠指標變為 ![文字指標](../common/text_mouse.svg)。
...
1. 將滑鼠指標置於文字上，此時滑鼠指標變為 ![手指](fig/fingers.png)。
...
> ![notes](../common/notes.svg)說明：如果您的電腦支援觸控屏或觸控板，可以使用手勢替代滑鼠操作：一指雙擊完成截圖。
...
<table class="block1">
    ...
    <tbody>
        <tr>
            ...
            <td>顯示按鍵</td>
               <td><img src="../common/webcam_normal.svg" alt="攝影機" class="inline" /></td>
            <td>開啟攝影機</td>
        </tr>
          <tr>
...
- 顯示按鍵：單擊![icon](../common/key_normal.svg)，錄屏時顯示鍵盤按鍵操作，最多同時顯示5個按鍵操作。
- 開啟攝影機：單擊![icon](../common/webcam_normal.svg)，啟動攝影機，錄屏時同時錄製攝影機畫面和螢幕畫面，拖曳攝影機視窗可以調整位置。
...
4. 單擊 ![icon](../common/recorder_button.svg) 按鈕，3秒倒數計時結束後開始錄製，此時工具列區域出現錄製圖示並閃爍。
5. 您可以使用以下方法結束錄製：
   - 使用快捷鍵 **Ctrl + Alt + R**。
   - 單擊任務欄上的截圖錄屏圖示。
   - 單擊工具列區域錄製圖示。
