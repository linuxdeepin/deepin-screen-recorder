...
QT += dtkgui dtkwidget KWindowSystem KWaylandClient KI18n KConfigCore
QT += dtkwidget
TEMPLATE = app
...
HEADERS += main_window.h \
    ...
    waylandrecord/writeframethread.h \
...
SOURCES += main.cpp \
    ...
    waylandrecord/writeframethread.cpp \
...
QT += concurrent
LIBS += -lX11 -lXext -lXtst -lXfixes -lopencv_core -lopencv_imgproc -lXcursor -lavcodec -lavdevice -lavfilter -lavformat -lavutil -lswscale -lswresample -lKF5WaylandClient -lKF5ConfigCore
