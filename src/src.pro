...
QT += dtkgui dtkwidget core widgets dbus concurrent KWindowSystem KWaylandClient KI18n KConfigCore
TEMPLATE = app
...
DEFINES += "DSR_LANG_PATH=\\\"$$DSR_LANG_PATH\\\"" QT_DEPRECATED_WARNINGS
