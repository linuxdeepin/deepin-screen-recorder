...
//        connect(m_pCameraWatcher, SIGNAL(sigCameraState(bool)), this, SLOT(on_CheckVideoCouldUse(bool)));
    ...
    if (m_screenInfo.size() == 2 && m_screenInfo.at(0).y != m_screenInfo.at(1).y && m_screenInfo.at(0).x != m_screenInfo.at(1).x) {
        ...
        if (is_inScreen1 = QRect(recordX, recordY, recordWidth, recordHeight).intersects(screen_1)) {
            intersectRect_1 = QRect(recordX, recordY, recordWidth, recordHeight).intersected(QRect(tmp_screenInfo.at(0).x, tmp_screenInfo.at(0).y, tmp_screenInfo.at(0).width, tmp_screenInfo.at(0).height));
        ...
        if (is_inScreen2 = QRect(recordX, recordY, recordWidth, recordHeight).intersects(screen_2)) {
            intersectRect_2 = QRect(recordX, recordY, recordWidth, recordHeight).intersected(QRect(tmp_screenInfo.at(1).x, tmp_screenInfo.at(1).y, tmp_screenInfo.at(1).width, tmp_screenInfo.at(1).height));
        ...
        qDebug() << "intersect rect: " << intersectRect_1 << intersectRect_2;
        qDebug() << "screen rect: " << screen_1 << screen_2;
        qDebug() << "is intersect corss : " << is_inScreen1 << is_inScreen2;
            ...
            if (area_1 > area_2) {   // screen1
                ...
                if (type == 0) {
                    if (intersectRect_1.x() + intersectRect_1.width() == tmp_screenInfo.at(0).x + tmp_screenInfo.at(0).width) {
                        qDebug() << "cross-1 out right x" << x << intersectRect_1.x() << tmp_screenInfo.at(0).width;
                    }

                    if (intersectRect_1.y() <= tmp_screenInfo.at(0).y) {
                        y = intersectRect_1.y() + intersectRect_1.height();
                    } else {
                        if (intersectRect_1.y() - tmp_screenInfo.at(0).y > m_toolBar->height() && intersectRect_1.y() + intersectRect_1.height() + m_toolBar->height() > tmp_screenInfo.at(1).y + tmp_screenInfo.at(1).height) {
                            y = intersectRect_1.y() - m_toolBar->height();
                        }
                    }
                }
        ...
        if (area_1 != 0 && area_2 == 0 && is_inScreen1 && !is_inScreen2 && area_1 != recordWidth * recordHeight) {
            ...
            if (intersectRect_1.x() + intersectRect_1.width() == tmp_screenInfo.at(0).x + tmp_screenInfo.at(0).width) {
                x = tmp_screenInfo.at(0).x + tmp_screenInfo.at(0).width - m_toolBar->width() - SIDEBAR_X_SPACING;
                qDebug() << "screen-1 out right x" << x << intersectRect_1.x() << tmp_screenInfo.at(0).width;
            }

            if (intersectRect_1.y() == tmp_screenInfo.at(0).y) {
                y = intersectRect_1.y() + intersectRect_1.height();
                qDebug() << "screen-1 out top y";
            } else if (intersectRect_1.y() + intersectRect_1.height() == tmp_screenInfo.at(0).y + tmp_screenInfo.at(0).height || intersectRect_1.y() + intersectRect_1.height() + m_toolBar->height() >= tmp_screenInfo.at(0).y + tmp_screenInfo.at(0).height) {
                y = intersectRect_1.y() - m_toolBar->height();
        ...
        if (area_1 == 0 && area_2 != 0 && !is_inScreen1 && is_inScreen2 && area_2 != recordWidth * recordHeight) {
            ...
            if (intersectRect_2.x() + intersectRect_2.width() == tmp_screenInfo.at(1).x + tmp_screenInfo.at(1).width) {
                ...
                qDebug() << "screen-2 out right x" << x << intersectRect_2.x() << tmp_screenInfo.at(1).width;
            }

            if (intersectRect_2.y() == tmp_screenInfo.at(1).y) {
                y = intersectRect_2.y() + intersectRect_2.height();
                qDebug() << "screen-2 out top y";
            } else if (intersectRect_2.y() + intersectRect_2.height() == tmp_screenInfo.at(1).y + tmp_screenInfo.at(1).height || intersectRect_2.y() + intersectRect_2.height() + m_toolBar->height() >= tmp_screenInfo.at(1).y + tmp_screenInfo.at(1).height) {
                y = intersectRect_2.y() - m_toolBar->height();
