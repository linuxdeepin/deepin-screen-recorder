 ...
 * Command line was: qdbusxml2cpp -N -p timewidget_interface -c timewidget_interface ./com.deepin.dde.daemon.Dock.xml
 *
...
// Add this struct definition before the timewidget_interface class
struct DockRect {
    int x;
    int y;
    uint width;
