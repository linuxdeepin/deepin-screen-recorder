...
#ifndef RECORDICONWIDGET_INTERFACE_H
#define RECORDICONWIDGET_INTERFACE_H
 ...
 */
class recordiconwidget_interface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    recordiconwidget_interface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~recordiconwidget_interface();
